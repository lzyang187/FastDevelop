 ...
 */
package com.lzy.libpermissions.easypermissions;
...
import com.lzy.libpermissions.easypermissions.custom.IRequestPermission;
import com.lzy.libpermissions.easypermissions.custom.XiaoMiPermissionImpl;
import com.lzy.libpermissions.easypermissions.helper.PermissionHelper;
...
public class EasyPermissions {
    ...
    public static IRequestPermission getRequestPermission() {
        IRequestPermission requestPermission = null;
        switch (RomUtil.getPhoneType()) {
            case RomUtil.BRAND_XIAOMI:
                requestPermission = new XiaoMiPermissionImpl();
                break;
            //可适配其他机型
        }
